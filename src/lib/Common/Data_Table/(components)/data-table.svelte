<script lang="ts">
  ...
  console.log ("Data Table Dataaaa>>>>>>", data)
...
<div class="space-y-2">
  ...
  <DataTableToolbar {tableModel} {data} {service_name}/>
          ...
          {#each $headerRows as headerRow}
            <Subscribe rowAttrs={headerRow.attrs()}>
              <Table.Row>
                ...
                <!-- Conditionally render Download column header if service_name is 'exp_download' -->
                {#if service_name === 'exp_download'}
                  <Table.Head style="vertical-align: top; padding-top: 5px;">
            ...
            {#each $pageRows as row, i (row.id)}
              <Subscribe rowAttrs={row.attrs()} let:rowAttrs>
                ...
                <Table.Row {...rowAttrs} class={`hover:bg-gray-200 dark:hover:bg-gray-700 ${i % 2 === 0 ? 'bg-gray-100 dark:bg-gray-800' : 'bg-white dark:bg-gray-900'}`}>
                  ...
                  <!-- Conditionally render Download button if service_name is 'exp_download' -->
                  {#if service_name === 'exp_download'}
                    <Table.Cell>
                      <Button>
                        Download
                  ...
                  <Table.Cell>
                    <Button on:click={() => goto('/exp-download/logs')}>
                      Logs
                    </Button>
                  </Table.Cell>
                </Table.Row>
